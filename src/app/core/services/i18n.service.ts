...
const VI: Translations = {
  ...
  // ── WS Secret ──
  'wssecret.title': 'Bí Mật WebSocket',
  'wssecret.desc': 'Quản lý khóa xác thực WebSocket cho các thiết bị',
  'wssecret.info': 'Khóa bí mật này được thiết bị sử dụng để xác thực kết nối WebSocket. Hãy giữ khóa này an toàn và chỉ chia sẻ với các thiết bị đáng tin cậy.',
  'wssecret.card_title': 'Khóa Bí Mật Hiện Tại',
  'wssecret.card_sub': 'Khóa này được sử dụng bởi tất cả các kết nối WebSocket',
  'wssecret.refresh': 'Làm mới',
  'wssecret.loading': 'Đang tải khóa bí mật...',
  'wssecret.no_key': 'Chưa có khóa nào được tạo. Sử dụng nút "Tạo khóa" để bắt đầu.',
  'wssecret.load_failed': 'Tải khóa thất bại',
  'wssecret.retry': 'Thử lại',
  'wssecret.secret_key': 'KHÓA BÍ MẬT',
  'wssecret.show': 'Hiện khóa',
  'wssecret.hide': 'Ẩn khóa',
  'wssecret.copy': 'Sao chép khóa',
  'wssecret.copied': 'Đã sao chép khóa!',
  'wssecret.created_at': 'NGÀY TẠO',
  'wssecret.updated_at': 'CẬP NHẬT LẦN CUỐI',
  'wssecret.generate_title': 'Tạo Khóa Mới',
  'wssecret.generate_desc': 'Tạo một khóa bí mật hoàn toàn mới. Khóa cũ sẽ bị thay thế và tất cả thiết bị sẽ mất kết nối.',
  'wssecret.generate': 'Tạo Khóa',
  'wssecret.generating': 'Đang tạo...',
  'wssecret.generated': 'Tạo khóa mới thành công!',
  'wssecret.generate_failed': 'Tạo khóa thất bại',
  'wssecret.renew_title': 'Gia Hạn Khóa',
  'wssecret.renew_desc': 'Xoay vòng khóa hiện tại. Thiết bị cần kết nối lại với khóa mới.',
  'wssecret.renew': 'Gia Hạn',
  'wssecret.renewing': 'Đang gia hạn...',
  'wssecret.renewed': 'Gia hạn khóa thành công!',
  'wssecret.renew_failed': 'Gia hạn khóa thất bại',
  'wssecret.guide_title': 'Hướng Dẫn Sử Dụng',
  'wssecret.guide_step1': 'Lấy khóa bí mật hiện tại từ trang này.',
  'wssecret.guide_step2': 'Cài đặt khóa này trong ứng dụng khách hoặc biến môi trường của thiết bị.',
  'wssecret.guide_step3': 'Thiết bị sử dụng khóa này để kết nối WebSocket.',
  'wssecret.guide_step4': 'Khi gia hạn/tạo mới khóa, hãy cập nhật lại tất cả thiết bị.',
  'wssecret.ws_endpoint': 'ĐIỂM KẾT NỐI WS',
};

const EN: Translations = {
  // ── Layout / Nav ──
  'nav.dashboard': 'Dashboard',
  'nav.ws_secret': 'WS Secret',
  ...
  // ── WS Secret ──
  'wssecret.title': 'WebSocket Secret',
  'wssecret.desc': 'Manage the WebSocket authentication secret key for devices',
  'wssecret.info': 'This secret key is used by devices to authenticate WebSocket connections. Keep it secure and only share with trusted client devices.',
  'wssecret.card_title': 'Current Secret Key',
  'wssecret.card_sub': 'This key is used by all WebSocket client connections',
  'wssecret.refresh': 'Refresh',
  'wssecret.loading': 'Loading secret key...',
  'wssecret.no_key': 'No key has been generated yet. Use the "Generate Key" button to get started.',
  'wssecret.load_failed': 'Failed to load secret key',
  'wssecret.retry': 'Retry',
  'wssecret.secret_key': 'SECRET KEY',
  'wssecret.show': 'Show key',
  'wssecret.hide': 'Hide key',
  'wssecret.copy': 'Copy key',
  'wssecret.copied': 'Key copied to clipboard!',
  'wssecret.created_at': 'CREATED AT',
  'wssecret.updated_at': 'LAST UPDATED',
  'wssecret.generate_title': 'Generate New Key',
  'wssecret.generate_desc': 'Create a brand-new secret key. The old key will be replaced and all devices will be disconnected.',
  'wssecret.generate': 'Generate Key',
  'wssecret.generating': 'Generating...',
  'wssecret.generated': 'New secret key generated!',
  'wssecret.generate_failed': 'Failed to generate key',
  'wssecret.renew_title': 'Renew Key',
  'wssecret.renew_desc': 'Rotate the current key. Devices will need to reconnect with the new key.',
  'wssecret.renew': 'Renew Key',
  'wssecret.renewing': 'Renewing...',
  'wssecret.renewed': 'Secret key renewed successfully!',
  'wssecret.renew_failed': 'Failed to renew key',
  'wssecret.guide_title': 'Usage Guide',
  'wssecret.guide_step1': 'Retrieve the current secret key from this page.',
  'wssecret.guide_step2': 'Configure the key in your client app or device environment variables.',
  'wssecret.guide_step3': 'The device uses this key to authenticate the WebSocket connection.',
  'wssecret.guide_step4': 'After renewing or generating a new key, update all devices accordingly.',
  'wssecret.ws_endpoint': 'WS ENDPOINT',
};
